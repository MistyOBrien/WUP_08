...
The residual standard error is 7.511 and the adjusted r-squared is 0.5075. Since the residual standard error is low and the adjusted r-squared is high, this is not the best model to predict. 
...
```
The one is better than the first model but lets check all the others to see if its the best.
...
```
This not better than the first model in fact its worst
